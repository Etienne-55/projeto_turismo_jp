...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controllers.CreateTripRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/controllers.CreateTripResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid request",
    ...
    "definitions": {
        ...
        "controllers.CreateTripResponse": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string",
